      ...
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <div data-aos="fade-up row" data-aos-delay="800">
            <form action="<?= base_url('welcome/cari_sanggar'); ?>" method="post">
            <div class="col-md-9">
      ...
      <div class="container">
        ...
        <div class="row faq-item d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            ...
            <?php foreach ($event as $b): ?>
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <a style="font-size: 12px" href="<?= site_url(); ?>welcome/detail_event/<?= $b['id']; ?>">selengkapnya...</a>
                </div>
          </div>
            <?php endforeach ?>
          </div>
          ...
          <div class="col-lg-4">
            ...
            <a style="font-size: 12px" href="<?= base_url(); ?>welcome/detail_berita/<?= $e['id']; ?>">selengkapnya...</a></p>       
            <?php endforeach ?>
          </div>
        </div><!-- End F.A.Q Item-->
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
            <div class="info">
              <div>
                ...
                <p>Universitas<br>Mercu Buana</p>
              </div>

              <div>
                <i class="ri-mail-send-line"></i>
                <p>sanggarsans@gmail.com</p>
              </div>
