...
<head>
  ...
  <link rel="icon" href="<?= base_url(); ?>assets/user/img/logo2.png">
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>leaflet-locatecontrol/dist/L.Control.Locate.min.css" />

  <script language="JavaScript" src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js"></script> 


  <script language="JavaScript" src="<?= base_url(); ?>leaflet-locatecontrol/src/L.Control.Locate.js"></script>
